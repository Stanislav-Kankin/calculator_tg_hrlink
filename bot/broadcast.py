...
async def send_broadcast(bot: Bot):
    ...
    message_text = (
        "В прошлом году кадровый ЭДО от HRlink помог компаниям "
        "подписать более 25 млн документов онлайн и сэкономить "
        "10 млн рабочих часов кадровых специалистов.\n\n"
        "Хотите также? Чтобы вы могли быстро оцифровать "
        "процессы КДП, мы подготовили набор из трех гайдов. Они помогут:\n\n"
